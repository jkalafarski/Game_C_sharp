...
public class TouchScriptL6 : MonoBehaviour {
	...
	void FixedUpdate()
	{
		if (alive) {
			...
			if (transform.position.x == -3 && transform.position.y == 0 || transform.position.x == 9 && transform.position.y == 0 || transform.position.x == 5 && transform.position.y == -4 || transform.position.x == -3 && transform.position.y == 8 || transform.position.x == -3 && transform.position.y == -8) {
				cubeRed1Script.RedBoxStepped ();
				cubeRed2Script.RedBoxStepped ();
				cubeRed3Script.RedBoxStepped ();
			;
				alive = false;
				Invoke ("next", 5); //Application.LoadLevel ("Level5");
